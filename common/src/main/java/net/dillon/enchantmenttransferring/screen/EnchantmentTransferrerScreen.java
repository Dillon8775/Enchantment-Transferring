...
public class EnchantmentTransferrerScreen extends ItemCombinerScreen<EnchantmentTransferrerMenu> {
    ...
    public EnchantmentTransferrerScreen(EnchantmentTransferrerMenu handler, Inventory inventory, Component title) {

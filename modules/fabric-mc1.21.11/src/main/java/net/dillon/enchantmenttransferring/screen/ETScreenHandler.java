 ...
 */
public class ETScreenHandler extends ForgingScreenHandler {
     ...
     */
    public ETScreenHandler(int syncId, PlayerInventory inventory) {
     ...
     * Base constructor.
     */
    public ETScreenHandler(int syncId, PlayerInventory inventory, ScreenHandlerContext context) {
        super(ETScreenHandlerTypes.ENCHANTMENT_TRANSFERRER, syncId, inventory, context, getForgingSlotsManager());
    ...
    protected boolean canUse(BlockState state) {
        return state.isOf(ETBlocks.ENCHANTMENT_TRANSFERRER);
    }

 ...
 */
public class EnchantmentTransferrerScreenHandler extends ForgingScreenHandler {
     ...
     */
    public EnchantmentTransferrerScreenHandler(int syncId, PlayerInventory inventory) {
     ...
     * Base constructor.
     */
    public EnchantmentTransferrerScreenHandler(int syncId, PlayerInventory inventory, ScreenHandlerContext context) {
        super(ModScreenHandlerTypes.ENCHANTMENT_TRANSFERRER, syncId, inventory, context, getForgingSlotsManager());
    ...
    private static ForgingSlotsManager getForgingSlotsManager() {
        return ForgingSlotsManager.builder()
                .input(0, 27, 47, stack -> true) // Enchanted tool
                .input(1, 76, 47, stack -> true) // Tool to transfer to
                .output(2, 134, 47).build(); // Output
    }
    ...
    protected boolean canUse(BlockState state) {
        return state.isOf(ModBlocks.ENCHANTMENT_TRANSFERRER);
    }
